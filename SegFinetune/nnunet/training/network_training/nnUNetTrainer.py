...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        if training:
            ...
            print("----------"+"nnUNetTrainer_initialize")
    ...
    def process_plans(self, plans):
        ...
        #self.patch_size = np.array(stage_plans['patch_size']).astype(int) #ycr
        #self.patch_size = np.array([96,96,96]).astype(int)
        self.patch_size = np.array([256,256]).astype(int)
        ...
        print("+----------------------"+"selfpatchsize:{}, num_input_channels:{}, num_classes:{}".format(self.patch_size, self.num_input_channels, self.num_classes))
    ...
    def run_online_evaluation(self, output, target):
        with torch.no_grad():
            ...
            output_softmax = softmax_helper(output) # ycr
            # output_sigmoid = sigmoid_helper(output)
