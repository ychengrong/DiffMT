...
def predict_cases(model, list_of_lists, output_filenames, epoch, folds, save_npz, num_threads_preprocessing,
    ...
    trainer, params = load_model_and_checkpoint_files(model, folds, epoch, mixed_precision=mixed_precision, checkpoint_name=checkpoint_name)
...
def predict_from_folder(model: str, input_folder: str, output_folder: str, epoch: str, folds: Union[Tuple[int], List[int]],
    ...
    if mode == "normal":
        ...
        return predict_cases(model, list_of_lists[part_id::num_parts], output_files[part_id::num_parts], epoch, folds,
...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', "--epoch", required=True, help="specil the checkpoint epoch")
    ...
    predict_from_folder(model, input_folder, output_folder, epoch, folds, save_npz, num_threads_preprocessing,
